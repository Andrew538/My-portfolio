    ...
    (() => {
        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                document.querySelector(".menu__body").classList.remove("menu-open") ? menuClose() : null;
        ...
        class SelectConstructor {
                ...
                if (targetElement.closest(this.getSelectClass(this.selectClasses.classSelect)) || targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag))) {
                    ...
                    if ("click" === targetType) {
                        if (!originalSelect.disabled) {
                            buttonForm.classList.add("button-hiden");
            ...
            selectsСlose(selectOneGroup) {
                ...
                })); else buttonForm.classList.remove("button-hiden");
            }
            selectСlose(selectItem) {
                ...
                if (!selectOptions.classList.contains("_slide")) {
                    selectItem.classList.remove("button-hiden")(this.selectClasses.classSelectOpen);
        ...
        (function() {
            ...
            alert("You are using: " + currentBrowser);
